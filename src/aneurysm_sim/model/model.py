...
def simulate_arterial_stress_and_pressure(params):
    """Computes individual component stress and pressure curves over a stretch sweep.
...
def _apply_collagen_shape_params(
    params, layer, rec_min, rec_max, rec_mode, stiffness_scale
):

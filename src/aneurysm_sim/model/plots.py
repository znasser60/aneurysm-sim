...
def plot_pressure_vs_diameter(results, n_zoom=125): 
    """
    ...
    plt.figure(figsize=(12, 8))
    plt.plot(sv_diam_var[:n_zoom], sv_pressure_var[:n_zoom]/1e3, 'k-', linewidth=6, label='Total')
    plt.plot(sv_diam_var[32:n_zoom], sv_pressure_var_elastin[32:n_zoom]/1e3, 'k--', linewidth=3, label='E')
    plt.plot(sv_diam_var[66:n_zoom], sv_pressure_var_coll[66:n_zoom]/1e3, 'k-.', linewidth=3, label='C')
    plt.plot(sv_diam_var[44:n_zoom], sv_pressure_var_muscle_p[44:n_zoom]/1e3, 'k+', linewidth=2, markersize=8, label='VSMCp')
    plt.plot(sv_diam_var[:n_zoom], sv_pressure_var_muscle_a[:n_zoom]/1e3, 'k.', linewidth=2, markersize=8, label='VSMCa')

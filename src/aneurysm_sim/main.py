...
def main():
    ...
    results = simulate_aneurysm(params, genotype="TT")
    plots.plot_normalised_densities(results)
    results = simulate_aneurysm(params, genotype="TC")
    plots.plot_normalised_densities(results)
    results = simulate_aneurysm(params, genotype="CC")
    plots.plot_normalised_densities(results)
